...
# class puppet::server::example42 inherits puppet::server {
#     File["puppet.conf"] {
...
#
# Note that this approach leaves you maximum flexibility on how to manage puppet application in your environment
