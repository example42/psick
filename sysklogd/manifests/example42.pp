...
# If $my_module_onmodule == yes Puppet tries to autoload example42::sysklogd
# that is:  MODULEPATH/example42/manifests/sysklogd.pp
#
...
#
# Note that this approach leaves you maximum flexinility on how to manage sysklogd application in your environment
