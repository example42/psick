...
# $foo_monitor_plugin (true|false) : Set if you want to monitor foo using specific monitor tool's plugins. If any. Default: As defined in $monitor_plugin
# 
...
class foo::monitor {
    ...
    # URL monitoring 
    monitor::url { "foo_url":
        url      => "${foo::params::monitor_baseurl}/index.php",
