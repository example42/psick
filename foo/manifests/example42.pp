...
# If $my_module_onmodule == yes Puppet tries to autoload example42::foo
# that is:  MODULEPATH/example42/manifests/foo.pp
#
...
#
# Note that this approach leaves you maximum flexinility on how to manage foo application in your environment
