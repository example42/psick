# psick::apache::tp
#
# @summary This psick manages apache with Tiny Puppet (tp)
#
# @example Include in other classes
#   include psick::apache::tp
# 
...
#   psick::apache::tp::ensure: present
#   psick::apache::tp::conf_hash:
#     apache.conf:
#       epp: psick/apache/apache.conf.epp
#     dot.conf:
#       epp: psick/apache/dot.conf.epp
#       base_dir: conf
#
