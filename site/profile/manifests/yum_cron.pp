...
#                hiera_hash('profile::yum_cron::options', {} ) and merged with
#                a default hash of options
#
class profile::yum_cron (
  Enum['present','absent'] $ensure  = 'present',
  String $config_file_template = 'profile/yum_cron/yum-cron.conf.erb',
) {
  ...
  $options_user=hiera_hash('profile::yum_cron::options', {} )
