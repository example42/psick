# @summary Manages classes executed only at the first Puppet run in darwin.
#
...
# triggers a reboot (once). Set profile::firstrun::darwin::reboot to false
# to avoid it.
#
# @example Enable firstrun and configure it to set hostname and reboot
#   firstrun_enable: true
#   profile::firstrun::darwin::hostname_class: profile::hostname
#
...
#   firstrun_enable: true
#   profile::firstrun::darwin::hostname_class: profile::hostname
#   profile::firstrun::darwin::proxy_class: profile::proxy
#   profile::firstrun::darwin::reboot: false
#
