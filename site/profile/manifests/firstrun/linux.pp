# @summary Manages classes executed only at the first Puppet run in linux.
#
...
# triggers a reboot (once). Set profile::firstrun::linux::reboot to false
# to avoid it.
#
# @example Enable firstrun and configure it to set hostname and reboot
#   firstrun_enable: true
#   profile::firstrun::linux::hostname_class: profile::hostname
#
...
#   firstrun_enable: true
#   profile::firstrun::linux::hostname_class: profile::hostname
#   profile::firstrun::linux::proxy_class: profile::proxy
#   profile::firstrun::linux::reboot: false
#
