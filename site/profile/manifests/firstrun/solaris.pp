...
# triggers a reboot (once). Set profile::firstrun::solaris::reboot to false
# to avoid it.
#
...
#   firstrun_enable: true
#   profile::firstrun::solaris::hostname_class: profile::hostname
#   profile::firstrun::solaris::proxy_class: profile::proxy
#   profile::firstrun::solaris::reboot: false
#
