...
#   profile::oracle::prerequisites::packages::use_defaults: true # Default value
#   profile::oracle::prerequisites::packages::extra_packages:
#     - toad
...
#
class profile::oracle::prerequisites::packages (
